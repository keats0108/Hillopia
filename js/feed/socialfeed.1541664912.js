                ...
                **/
                ...
                getData: function(account) {
                    ...
                    if(typeof account != 'undefined' && account && typeof options.instagram.access_token != 'undefined') {                        
                        url = Feed.instagram.api + 'users/' + account + '/media/recent/?count=' + options.instagram.limit + '&access_token=' + options.instagram.access_token;
                ...
                utility: {
                    getImages: function(json) {
                        if (typeof json.data != 'undefined' && json.data.length > 0) {
                            ...
                            var error = (typeof json.meta != 'undefined' && json.meta.error_message) ? json.meta.error_message : '';
...
var updateFeed = function(el,snsObject) {
    ...
    var sns_twitter = String(snsObject.twitter).split(","),
        sns_facebook = String(snsObject.facebook).split(","),
        sns_instagram = (typeof snsObject.instagram == 'object') ? snsObject.instagram : String(snsObject.instagram).split(",");

    var check_twitter = (sns_twitter[0].length > 0) ? false : true,
        check_instagram = ((typeof snsObject.instagram=='object' && sns_instagram.id.length>0) || (typeof sns_instagram[0]!='undefined' && sns_instagram[0].length > 0) ) ? false : true,
        check_empty = (check_twitter && check_instagram) ? true : false;
   
    if(typeof snsObject == "undefined") {
        snsObject = {
            "twitter" : [""],
            "facebook" : [""],
            "instagram" : [""]
    ...
    if(isGetData) {
        ...
        $('.' + el + ' .social-feed-container').socialfeed({
            ...
            facebook: {
                accounts: sns_facebook,
                limit: limit_facebook,
                access_token: '110859402598144|9eab5eed1805d2c74d696ef151c32ea5'
            },
            instagram: {
                accounts: (typeof snsObject.instagram == 'object' && typeof sns_instagram.id != 'undefined') ? String(sns_instagram.id).split(' ') : sns_instagram,
                limit: limit_instagram,
                access_token: (typeof snsObject.instagram == 'object' && typeof sns_instagram.token != 'undefined') ? sns_instagram.token : '3150770084.2bca826.5e2ded8c9d40478d8f35dc584045f11c',
                // accounts: sns_instagram, //asdf before code
                //client_id: '2bca82639e3e4970a514d5b8220eec1b', // ok
                //client_id: '88b4730e0e2c4b2f8a09a6184af2e218', // ok
                //client_id: 'b532ef4f95654034afb0630258199cea', // ok 2bca82639e3e4970a514d5b8220eec1b org
                // client_id: '',  //asdf before code
                // access_token: '3150770084.2bca826.5e2ded8c9d40478d8f35dc584045f11c'  //asdf before code
                //access_token: ''
            },
            // GENERAL SETTINGS
            length: postLength,
            ...
            check_get_data: { 'twitter': check_twitter, 'instagram': check_instagram },
            total: 0,
            ...
            callback: function() {
                var post_count = $('.'+el+' .social-feed-container').children().length,
                    feed_view = (typeof $('.'+el).attr('data-feed-view') != 'undefined') ? $('.'+el).attr('data-feed-view') : 0;
